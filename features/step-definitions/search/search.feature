Feature: Search Functionality
	...
	@runThis
	Scenario Outline: Should be able to show the see more button and scroll down to the bottom of the search modal
	Given I am on the Mamikos homepage
	When I click on the search button
	Then I should see the search modal
	And I input the keyword "<keyword>"
	Then I should see the suggestion box
	Then I should see the See More button
	Then I click on the See More button
	Then I should move to the bottom of the search modal
